...
export default function Hero() {
  ...
  return (
      <section
        className="min-h-screen w-full text-white flex flex-col items-center justify-center px-4 py-16 md:pb-40 relative overflow-hidden"
        style={{
          background: `
            conic-gradient(
      ...
      <div className="text-center flex flex-col justify-center items-center gap-8">
        ...
        <h1 className="text-xl md:text-5xl font-bold tracking-wide">BABAK NIKFAR</h1>
