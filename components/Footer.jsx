...
const Footer = () => {
  return (
    <footer className="flex flex-col justify-center items-center gap-3 p-14 mb-8" dir="rtl">
      <div className="flex flex-col justify-center items-center text-center gap-10">
        ...
        className="bg-[#AFA7FF] text-black md:px-12 px-6 py-4 rounded-lg cursor-pointer font-bold text-lg"
        >
            عضویت در کلاب
        </button>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full px-8 gap-10">
            <div className="flex flex-col justify-center items-start gap-4">
                ...
                <p className="text-sm">امیرآباد شمالی، خیابان فرشی مقدم، پارک علم و فناوری دانشگاه تهران.</p>
